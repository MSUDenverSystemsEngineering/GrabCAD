...
Try {
	...
	[string]$appVendor = 'Stratasys'
	[string]$appName = 'GrabCAD Print'
	[string]$appVersion = '1.77.13.26873'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'grabcadprint' -CheckDiskSpace -PersistPrompt
		...
		## <Perform Installation tasks here>
			...
			$exitCode = Execute-Process -Path "$dirFiles\GrabCAD-Print-Installer-PerMachine.exe" -Parameters '/quiet' -WindowStyle 'Hidden' -PassThru
			If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		...
		If (Test-Path "$env:Public\Desktop\GrabCAD Print.lnk") {
			Remove-Item "$env:Public\Desktop\GrabCAD Print.lnk" -Force
		}
		Else {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'grabcadprint' -CloseAppsCountdown 60
		...
		#$exitCode = Execute-MSI -Action Uninstall -Path "{880BE667-C890-40D6-AD30-BB46089BCFE3}" -Parameters '/qn' -PassThru
		$exitCode = Execute-Process -Path "$dirFiles\GrabCAD-Print-Installer-PerMachine.exe" -Parameters '/uninstall /quiet' -WindowStyle 'Hidden' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDMRsJ3599W6he2
# 5FdnENwMFjQxCeYPxbwRqWxYeeTvKaCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgwaGZx1Ea3are
# 73cPOBJ2B1+hWMkIXmTDw4clcaWbKvQwDQYJKoZIhvcNAQEBBQAEggGAR5Ku9Z8V
# r+QJEwqiuKpuKM4cO+AAJ0mH4pYLL0455zHyH8DDv08+2RMOtIFj7rlMocuWO+Dn
# YHSNCcF0ywkBtA3u2gNFO8Zq4lpKT2IlT1lNAjKPkaL/4s2gRyNt6bFVhTKQ4RZ5
# HrvWBv+BrfFxu3sd0PM8DVOF+NfMxtjUerhmVb7LPGVeXh5AwimxPyOdAmxlM1oQ
# tVOJ2uItM0MUA2yPsRYGxL7x55ZtSuOVsxrnxIwiXYT6CEHGr78ksaM3CfgnxxPZ
# 99AD2ttCo74cJjvzCccYAsE5qZt7CrLuTfnVnOFr0yyrvbhCd7rlHqVyMskdueLW
# UY69Z3CNe+Ai1tVTPon1/d3gnqJIeD7bHzAWBAFbkCHfQKtTGT9117t5E7RN9siN
# jgdI23hvbbIs13URCKPEM9Y9W29GhsZ1nHJhMp9HTEsqcm0FJZylAX//YI5X/qSE
# 6ig0XeJIZ4dmJ2XWxv89ustuDUtnnuL87w0a364kAyeSXwLMPVhyrEwaoYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzA0MTgx
# NjEzNTVaMD8GCSqGSIb3DQEJBDEyBDABeJLMYUxKtIqZOE+xV/W7HqFKwJkRwBKy
# yoFrxZIVYip8wrRMm6+u2FMauQRkEjQwDQYJKoZIhvcNAQEBBQAEggIAkCg5SQor
# uLxEqLewYYnGWNiitGh5GigetDOa1V/bXii6t2PhxRvqAnpcRw9VVdX3lKe17gUr
# qCUEaFlRlRUicVnp/zhPEQxaQSq3qejllRCeo9vDhMRGzrspJH0JUXWCk+neOmLJ
# lEgZ700H79Lmjo3d67DsRCdsp+YaqnUGDGQUNy2P42MT9VE2R8AkKvkh54X+BvwA
# 8Dml3yYaMBFWzjSLU96J0enu3LoSGeDnAqzEjelApxIqXCZBaczHogp9tilFNegZ
# OZ8rbVtUv2tR9s/kthYKu41HXP0JmnOmUiHUxLD75/Xi3u6WDpMIS+wmzR/w352c
# Q3wtCjnsMqs3zbN1hY8D1yia8rgmdIRJRncXtY5VS6aV+MJbpmmcQJE+gqncNnM3
# NIkm4k3n/HykVE8asXJBEIqod2Oq1W5jEIRphjJuGm61Ivxqv8XuUxcIh2z4ZYhw
# eefCxCVX68t36nB35gT7GZ2kh0ePxIWgfOH85a8vJcEFxDxQ8p+RZa7NrZwukLmo
# 8rAAr6nVHcPlvW+fvAizryEL38s1BuOavZGaXSNXWnq03L1kLdz51u0ZoRdoWkBF
# BrrFLVo7K1PMWf++QPghmnHnICTaP0PQY7DY+AGEezwWiQ9NegTs1Raodb7DMnAv
# XNLLbws2bnBiRRoOCeQXE90HjBOWNGaLd18=
